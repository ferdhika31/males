							...
							<table class="table table-bordered table-striped table-condensed">
								...
								?>
									<tr>
										...
										<td class="center">
										<?php echo ($data->hak==1) ? "<span class=\"label label-success\">Admin</span>" : "<span class=\"label\">Writer</span>";?>

										</td>
										<td class="center">
											<a class="btn btn-info" href="<?php echo $this->location('admin/user/ubah/'.$data->user_id);?>">
												<i class="icon-edit "></i>                                            
											</a>
											<a class="btn btn-danger" href="<?php echo $this->location('admin/user/hapus/'.$data->user_id);?>">
								...
								<thead>
									<tr>
										<th colspan="6">
											<center>
												<a class="btn btn-success" title="Tambah data" href="<?php echo $this->location('admin/user/tambah');?>">
